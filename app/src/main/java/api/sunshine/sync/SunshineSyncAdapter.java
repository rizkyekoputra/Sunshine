...
import api.sunshine.MainActivity;
import api.sunshine.R;
import api.sunshine.Utility;
...
public class SunshineSyncAdapter extends AbstractThreadedSyncAdapter {
    ...
    private static final String[] NOTIFY_WEATHER_PROJECTION = new
            String[] {
    ...
    public void onPerformSync(Account account, Bundle extras, String authority, ContentProviderClient provider, SyncResult syncResult) {
        ...
        try {
            ...
            if (cVVector.size() > 0) {
                ...
                Calendar cal = Calendar.getInstance(); // Get's a calendar object with the crrent time.
    ...
    private void notifyWeather() {
        ...
        if ( displayNotifications ) {
            ...
            if (System.currentTimeMillis() - lastSync >= DAY_IN_MILLIS) {
                // Last sync was more than 1 day ago, let's send anotification with the weather.
                ...
                if (cursor.moveToFirst()) {
                    ...
                    // notifation. Just throw in some data.
                    ...
                    // started Activity.
                    // This ensures taht navigating backward from the Activity leads out of
                    // your applicaition to the Home screen.
    ...
    /**
     * Helper methodd to get the fake account to be used with SyncAdapter, or make a new one
     * if the fake account doesn't exist yet. If we make a new account, we call the
     * on AccountCreated method so we can initialize things.
     *
     * @param context The context used to access the account service
     * @return a fake account
     */
    public static Account getSyncAccount(Context context) {
        // Get an instance of theAndroid account manager
    ...
    private static void onAccountCreated(Account newAccount, Context context) {
        ...
        /*
         * Without  calling setSynAutomatically, our periodic sync will not be enabled.
         */
