...
public class Utility {
    ...
    public static String formatTemperature(Context context, double temperature) {
        // Data stored in Celcius by default. if user prefers to see in Fahrenheit, convert
        // the values here.
        String suffix = "\u00B0";
        if (!isMetric(context)) {
    ...
    // Format used for storing dates in database. Also used for converting those strings
